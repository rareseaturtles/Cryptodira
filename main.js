...
window.addEventListener('load', () => {
  const walletConnectEl = document.getElementById('wallet-connect');
  const root = ReactDOM.createRoot(walletConnectEl);
  root.render(
...
document.body.addEventListener('click', (e) => {
 const button = e.target.closest('.button, #darkModeToggle, #create-wallet-btn, #donate-btn');
 if (button) {
