...
document.body.addEventListener('click', (e) => {
  const button = e.target.closest('.button, #darkModeToggle, #claim-wallet-btn, #connect-wallet-btn, #donate-btn, #refresh-balance, #copy-public-btn, #copy-seed-btn, #reveal-private-btn, #copy-private-btn, #modal-close');
  if (button) {
    ...
    else if (button.id === 'copy-private-btn') copyText(modalPrivateKeyText.innerText);
